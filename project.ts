...
interface EPerson {
  ...
  const organizer = new EOrganizer(1, "Sahid","sahid@example.com");
  const user1 = new EUser(2, "Rakesh Nath", "rakesh@example.com");
  const user2 = new EUser(3, "birendra singh","singh@example.com");
